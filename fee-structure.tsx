...
export default function FeeStructure() {
  ...
  return (
    <section id="fee-structure" ref={sectionRef} className={`py-16 bg-white relative overflow-hidden md:-mb-40 transition-all duration-700 scroll-mt-[100px] lg:scroll-mt-24 xl:scroll-mt-28 ${inView ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
      {/* Decorative shape */}
