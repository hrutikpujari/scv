...
export default function AdmissionProcess() {
  ...
  return (
    <section id="not-admission-process" ref={sectionRef} className={`py-16 bg-white relative overflow-hidden transition-all duration-700 ${inView ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
      {/* Decorative shape */}
