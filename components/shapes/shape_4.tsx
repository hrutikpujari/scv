...
export default function Shape4({ className = "", uid = "a" }: Shape4Props) {
  const clipId = `clip0_648_541_${uid}`
  const gradientId = `paint0_linear_648_541_${uid}`
  const maskId = `mask0_648_541_${uid}`
  return (
    <svg
      className={className + ""}
      viewBox="0 0 216 216"
