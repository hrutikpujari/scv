...
export default function AdmissionsEnquiryForm() {
  ...
  return (
    <section id="admissions-enquiry-form" ref={sectionRef} className={`mt-20 pb-10 md:py-16 px-6 bg-white rounded-lg max-w-2xl mx-auto my-12 transition-all duration-700 scroll-mt-[100px] lg:scroll-mt-24 xl:scroll-mt-28 ${inView ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
